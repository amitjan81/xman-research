...
**The Nifty comparison has to be made in rupees, not in the ratio.** At the same moneyness Nifty's front put moved ₹1.40 → ₹1.45, which is nominally 21× smaller in percentage terms — but it is **one tick on a ₹1.40 option**, and a ratio of two such percentages is a ratio of ticks. The comparison that carries weight is the 12-day Nifty put, whose premium (₹6.75) is within striking distance of the Sensex wing's ₹11.60: it moved ₹0.30 against the Sensex wing's ₹7.75. Sensex's wing repriced roughly an order of magnitude harder than Nifty's on a comparable premium — and both moves are small enough that the whole comparison lives inside a few rupees.
